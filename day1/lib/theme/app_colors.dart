...
/// Color palette — exact reference-matched tones from user image.
class AppColors {
  AppColors._();
  ...
  /// Secondary label text / subtitle (#71797E)
  static const Color secondaryText = Color(0xFF71797E);

  /// White surfaces (#FFFFFF)
  static const Color white = Color(0xFFFFFFFF);

  /// Notification badge dot (#FF3B30)
